  ...
  .mockImplementationOnce(() =>
    Promise.resolve({
      Parameters: [
        ...
        { Name: 'TEST/THREE', Value: '3' },
        { Name: 'TEST/FOUR', Value: '4' },
        { Name: 'TEST/FIVE', Value: '5' },
        { Name: 'TEST/SIX', Value: '6' },
        { Name: 'TEST/SEVEN', Value: '7' },
        { Name: 'TEST/EIGHT', Value: '8' },
        { Name: 'TEST/NINE', Value: '9' },
        { Name: 'TEST/TEN', Value: '10' }
      ]
    })
  )
  .mockImplementationOnce(() =>
    Promise.resolve({
      Parameters: [{ Name: 'TEST/ELEVEN', Value: '11' }]
    })
  );
