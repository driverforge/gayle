  ...
  it('should provide a callback onComplete to allow for logging', () => {
    ...
    return updateSecrets({
      ...
      const onCompleteHook =
        mockProviderUpdateSecrets.mock.calls[0][0].onComplete;
      ...
      expect(mockGray.mock.calls[2][0]).toEqual(
        'Updated secret: Name: THE KEY | Value: [8 chars] | Version: [00000000003]',
      );
    });
  });
});
